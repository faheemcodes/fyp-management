...
$routes = [
    ...
    '/admin/notice' => ['Controller\AdminController', 'notice'],
    '/admin/notice/create' => ['Controller\AdminController', 'createNotice'],
    '/admin/notice/toggle' => ['Controller\AdminController', 'toggleNoticeVisibility'],
    '/admin/notice/delete' => ['Controller\AdminController', 'deleteNotice'],
    ...
    '/admin/settings/update' => ['Controller\AdminController', 'updateSettings'],
    '/admin/previous-projects' => ['Controller\PreviousProjectsController', 'index'],
