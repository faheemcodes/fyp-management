                    ...
                    <td class="ps-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <small class="text-muted d-block" style="font-size: 0.72rem;"><i class="bi bi-envelope me-1" style="font-size: 0.68rem;"></i><?php echo htmlspecialchars($s['email'], ENT_QUOTES, 'UTF-8'); ?></small>
                            </div>
                        </div>
                    </td>
