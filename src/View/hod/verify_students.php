        ...
        <div class="d-flex flex-column flex-md-row align-items-center gap-4 text-center text-md-start">
            ...
            <div>
                <div class="d-flex align-items-center gap-2 justify-content-center justify-content-md-start flex-wrap">
                    <h4 class="text-white fw-bold m-0" style="font-size: 1.35rem; letter-spacing: -0.02em">Verify Students</h4>
                ...
                <p class="mb-0 mt-1" style="color: rgba(255,255,255,0.75); font-size: 0.85rem">Pending student registration requests</p>
            </div>
        </div>
        ...
        <div class="row g-3 align-items-center w-100 m-0">
            ...
            <div class="col-md-6 ps-0">
                <div class="input-group shadow-sm rounded-pill overflow-hidden border border-light-subtle">
                    ...
                    <input type="text" class="form-control border-0 ps-0 table-search shadow-none" placeholder="Search pending students..." data-target="pending-students-table">
                </div>
            </div>
            <div class="col-md-6 pe-0 text-md-end text-muted small">
                Total: <strong><?php echo $pendingCount; ?></strong> pending
            </div>
        </div>
    </div>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden; background: var(--card-bg);">
            <div class="modal-header border-0 bg-danger bg-opacity-10 py-3 px-4">
                <div class="d-flex align-items-center gap-2 text-danger">
                    ...
                    <h5 class="modal-title fw-bold m-0" style="font-size: 1.1rem;">Reject Student</h5>
                </div>
            ...
            <form action="<?php echo $basePath; ?>/hod/students/reject" method="POST">
                ...
                <div class="modal-body p-4">
                    <p class="text-muted small mb-3">Rejecting registration for <strong id="rejectStudentName" style="color: var(--text-primary);"></strong>.</p>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-0 p-3" style="background: var(--form-bg); border-top: 1px solid var(--border-color) !important;">
                    ...
                    <button type="submit" class="btn btn-danger rounded-pill px-4 fw-semibold">Reject</button>
                </div>
            </form>
        </div>
    </div>
