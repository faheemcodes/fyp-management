...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-4">
        <div class="stat-card p-4 d-flex align-items-center justify-content-between">
            <div>
                <h6 class="text-muted small text-uppercase mb-2 font-weight-bold">Scheduled Presentation Sessions</h6>
                <h3 class="m-0 fw-bold text-warning animate-pulse"><?php echo $scheduledCount; ?></h3>
            </div>
