...
<div class="card border-0 p-3 p-md-4 mb-4">
    <div class="section-title mb-4 d-flex justify-content-between align-items-center">
        <div><i class="bi bi-people-fill text-primary me-2"></i> FYP Student Groups & Stages</div>
        <a href="<?php echo $bp; ?>/committee/evaluations" class="btn btn-sm btn-outline-primary d-md-none rounded-pill px-3">
