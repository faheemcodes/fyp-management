<!-- Coordinator Verify Students View -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <a href="<?php echo dirname($_SERVER['SCRIPT_NAME']) === '/' || dirname($_SERVER['SCRIPT_NAME']) === '\\' ? '' : dirname($_SERVER['SCRIPT_NAME']); ?>/coordinator/users/approve?id=<?php echo $s['user_id']; ?>" class="btn btn-sm btn-success text-white rounded-pill px-3 me-1" onclick="return confirm('Are you sure you want to approve this student?')">Approve</a>
                        <a href="<?php echo dirname($_SERVER['SCRIPT_NAME']) === '/' || dirname($_SERVER['SCRIPT_NAME']) === '\\' ? '' : dirname($_SERVER['SCRIPT_NAME']); ?>/coordinator/users/reject?id=<?php echo $s['user_id']; ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3" onclick="return confirm('Are you sure you want to reject this student registration? This will delete their record permanently.')">Reject</a>
                    </td>
                </tr>
