        ...
        <div class="flex-grow-1 text-center text-md-start">
            <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mb-1">
                <h4 class="text-white fw-bold m-0" style="font-size: 1.3rem;letter-spacing: -0.02em">
                    <?php echo htmlspecialchars(formatPersonName($prefixVal, $coordinator['name'] ?? '', $surnameVal)); ?>
                </h4>
                <span class="badge bg-success text-white border border-light border-opacity-25 rounded-pill px-2 py-1" style="font-size: 0.65rem;letter-spacing: 0.5px">Coordinator</span>
            </div>
            <p class="mb-2" style="color: rgba(255,255,255,0.7);font-size: 0.82rem">
                <i class="bi bi-diagram-3 me-1"></i>FYP Coordinator
                <span class="d-none d-md-inline">
                    &nbsp;·&nbsp;
                    <i class="bi bi-envelope me-1"></i><?php echo htmlspecialchars($coordinator['email']); ?>
                </span>
            </p>
...
<form action="<?php echo $basePath; ?>/coordinator/profile" method="POST">
    <div class="row g-4">
                ...
                <div class="page-section-body">
                    <div class="row g-3">
                        ...
                        <div class="col-8 pf-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($coordinator['name']); ?>" disabled readonly>
                        ...
                        <div class="col-6 pf-group">
                            ...
                            <input type="text" class="form-control" value="Department Coordinator" disabled readonly>
                            <span class="pf-locked-tag"><i class="bi bi-lock-fill"></i> Locked</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12 pf-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" value="<?php echo htmlspecialchars($coordinator['email']); ?>" disabled readonly style="border-radius: 0 10px 10px 0">
                            </div>
                            <span class="pf-locked-tag"><i class="bi bi-lock-fill"></i> Locked</span>
                        </div>
                        <div class="col-4 pf-group">
