        ...
        <div class="flex-grow-1 text-center text-md-start">
            <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mb-1">
                <h4 class="text-white fw-bold m-0" style="font-size: 1.3rem; letter-spacing: -0.02em;">
                    <?php echo htmlspecialchars(($prefixVal ? $prefixVal . ' ' : '') . $coordinator['name']); ?>
                </h4>
                <span class="badge bg-primary bg-opacity-25 text-info border border-info border-opacity-25 rounded-pill px-2 py-1" style="font-size: 0.65rem; letter-spacing: 0.5px;">Coordinator</span>
            </div>
