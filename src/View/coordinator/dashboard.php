...
<!-- ── Main Content Row: Recent Notices (col-lg-4) & Pending Proposals (col-lg-8) ── -->
<div class="row g-4 mb-4">
            ...
            <div class="page-section-header mb-4 position-relative d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        ...
                        <small style="font-size: 0.74rem;">Department announcements</small>
                    </div>
                </div>
                <a href="<?php echo $bp; ?>/coordinator/notice" class="btn btn-outline-primary btn-sm rounded-pill px-3" style="font-size: 0.72rem; font-weight: 600;">
                    Manage
                </a>
            </div>
            
            <div class="notice-list custom-scroll" style="max-height: 440px; overflow-y: auto;">
    ...
    <!-- ── Pending Proposals Table (col-lg-8) ── -->
    <div class="col-lg-8">
        ...
        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden" style="background: var(--card-bg);">
            ...
            <div class="modal-body text-center p-4 pt-1">
                <div class="position-relative d-inline-block mb-3">
                    <div class="rounded-circle p-1" style="background: linear-gradient(135deg, #2563eb, #1d4ed8);">
...
<?php 
$noticesForModal = isset($recentNotices) ? $recentNotices : [];
...
foreach($noticesForModal as $n): 
    ...
    $coordDept = $coordUser ? $coordUser['department'] : ($department ?? 'Computer Science');
                ...
                <div class="letterhead-container w-100" style="background: #fdfcfb; max-width: 820px; padding: 60px 70px; box-shadow: 0 20px 40px rgba(0,0,0,0.2); border-radius: 8px; position: relative; min-height: 1060px; display: flex; flex-direction: column; justify-content: space-between; overflow: hidden; font-family: 'Lora', Georgia, serif; color: #1e293b; text-align: left;">
                    ...
                    <div class="letterhead-content" style="position: relative; z-index: 1;">
                        ...
                        <div class="subject-line" style="font-size: 1rem; font-weight: bold; margin-bottom: 20px; color: #0f172a; border-left: 3px solid #1e3a8a; padding-left: 12px;">
                            SUBJECT: <?php echo strtoupper(htmlspecialchars($n['subject'])); ?>
                        </div>

                        <div class="body-content" style="font-size: 0.98rem; line-height: 1.8; color: #1e293b; margin-bottom: 45px; white-space: pre-line;">
                            <?php echo htmlspecialchars($n['body']); ?>
                        </div>
                    </div>

                    <div class="signatures-section d-flex justify-content-between align-items-end" style="padding-top: 40px; position: relative; z-index: 1;">
                        <div class="signature-line text-center" style="width: 200px; border-top: 1px solid #475569; padding-top: 8px; position: relative;">
                            <div class="signature-cursive" style="position: absolute; top: -35px; left: 20px; font-family: 'Great Vibes', cursive; font-size: 1.8rem; color: #0f172a; pointer-events: none;">
                                <?php echo htmlspecialchars($coordName); ?>
                            </div>
                            <div class="fw-bold" style="font-size: 0.9rem; color: #0f172a;"><?php echo htmlspecialchars($coordName); ?></div>
                            <div class="sign-title text-muted" style="font-size: 0.8rem;">FYP Coordinator</div>
                            <div class="sign-title text-muted x-small" style="font-size: 0.72rem;">Dept. of <?php echo htmlspecialchars($coordDept); ?></div>
                        </div>
                        ...
                        <div class="signature-line text-center" style="width: 200px; border-top: 1px solid #475569; padding-top: 8px; position: relative;">
                            ...
                            <div class="fw-bold" style="font-size: 0.9rem; color: #0f172a;"><?php echo htmlspecialchars($hodName); ?></div>
                            <div class="sign-title text-muted" style="font-size: 0.8rem;">Head of Department</div>
                            <div class="sign-title text-muted x-small" style="font-size: 0.72rem;">Dept. of <?php echo htmlspecialchars($coordDept); ?></div>
                        </div>
                    </div>
