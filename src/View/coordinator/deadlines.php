                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end align-items-center" style="gap: 6px;">
                                    ...
                                    <!-- Delete Button -->
                                    <form action="<?php echo $basePath; ?>/coordinator/deadlines/delete" method="POST" class="m-0" onsubmit="return confirm('Are you sure you want to remove the deadline for &quot;<?php echo htmlspecialchars($dl['stage'], ENT_QUOTES, 'UTF-8'); ?>&quot;?');">
                                        <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
