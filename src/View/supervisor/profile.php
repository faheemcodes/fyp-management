...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm rounded-3 p-4 bg-white mb-4">
            ...
            <!-- Profile Header centered & placed above name -->
            <div class="text-center border-bottom pb-4 mb-4 position-relative">
                <span class="badge bg-secondary text-uppercase py-2 px-3 position-absolute end-0 top-0 d-none d-sm-inline-block">Supervisor Portal</span>
                <div class="d-inline-block mb-3">
                    <div class="avatar bg-primary text-white rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 100px; height: 100px; font-size: 2.2rem; font-weight: 600;">
                        <?php echo strtoupper(substr($supervisor['name'], 0, 1)); ?>
                    </div>
                </div>
                <h4 class="fw-bold text-dark m-0"><?php echo htmlspecialchars($supervisor['name']); ?></h4>
                <p class="text-muted small m-0 mt-1">Email: <?php echo htmlspecialchars($supervisor['email'] ?? 'N/A'); ?> &bull; Supervisor Portal</p>
            </div>
            ...
            <form action="<?php echo $basePath; ?>/supervisor/profile" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold text-secondary">CNIC</label>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" value="<?php echo htmlspecialchars($supervisor['email']); ?>" disabled readonly>
                        <div class="form-text small text-muted">Permanent (Registration-locked).</div>
                    </div>
