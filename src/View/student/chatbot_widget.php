...
<div id="ai-chatbot-widget">
    ...
    <button id="ai-chat-fab" style="width:56px;height:56px;border-radius:50%;border:none;cursor:pointer;position:relative;background:linear-gradient(135deg,#64748b,#475569);color:#fff;font-size:1.3rem;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 24px rgba(100,116,139,0.45);">
...
#ai-chat-fab:hover {
    ...
    box-shadow: 0 8px 32px rgba(100,116,139,0.55) !important;
}
.ai-fab-pulse {
    position: absolute;
    inset: -5px;
...
/* ─── Header (Glass) ─── */
.ai-chat-header {
    background: linear-gradient(135deg, rgba(100,116,139,0.92), rgba(37,99,235,0.92));
...
#ai-chat-body::-webkit-scrollbar-thumb { background: rgba(100,116,139,0.2); border-radius: 4px; }
#ai-chat-body::-webkit-scrollbar-thumb:hover { background: rgba(100,116,139,0.35); }
...
.ai-quick-btn i { color: #64748b; font-size: 0.85rem; flex-shrink: 0; }
...
#ai-send-btn:not(:disabled):hover {
    ...
    box-shadow: 0 2px 10px rgba(100,116,139,0.35);
}
.ai-disclaimer {
    text-align: center;
    font-size: 0.62rem;
