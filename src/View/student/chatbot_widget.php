...
<div id="ai-chatbot-widget">
    ...
    <button id="ai-chat-fab" style="width:56px;height:56px;border-radius:50%;border:none;cursor:pointer;position:relative;background:linear-gradient(135deg,#343638,#1a1b1c);color:#fff;font-size:1.3rem;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 24px rgba(52,54,56,0.45);">
...
#ai-chat-fab:hover {
    ...
    box-shadow: 0 8px 32px rgba(52,54,56,0.55) !important;
}
.ai-fab-pulse {
    position: absolute;
    inset: -5px;
    border-radius: 50%;
    border: 2px solid rgba(52,54,56,0.4);
...
/* ─── Header (Glass) ─── */
.ai-chat-header {
    background: linear-gradient(135deg, rgba(52,54,56,0.92), rgba(37,99,235,0.92));
...
#ai-chat-body::-webkit-scrollbar-thumb { background: rgba(52,54,56,0.2); border-radius: 4px; }
#ai-chat-body::-webkit-scrollbar-thumb:hover { background: rgba(52,54,56,0.35); }
...
.ai-welcome-icon {
    ...
    margin: 0 auto 12px;
    border-radius: 14px;
    background: linear-gradient(135deg, #343638, #1a1b1c);
    color: white;
    display: flex;
    align-items: center;
    justify-content: center;
    font-size: 1.4rem;
    box-shadow: 0 6px 20px rgba(52,54,56,0.3);
}
.ai-welcome-title {
    font-size: 1rem;
    font-weight: 700;
...
.ai-quick-btn {
    border: 1px solid rgba(52,54,56,0.15);
    background: var(--card-bg);
...
.ai-quick-btn i { color: #343638; font-size: 0.85rem; flex-shrink: 0; }
html.dark-theme .ai-quick-btn i { color: var(--text-primary); }
.ai-quick-btn:hover {
    border-color: #343638;
    background: rgba(52,54,56,0.08);
    color: #343638;
    transform: translateY(-1px);
    box-shadow: 0 2px 8px rgba(52,54,56,0.12);
}
html.dark-theme .ai-quick-btn {
    background: var(--card-bg);
    border-color: rgba(52,54,56,0.2);
    color: var(--text-primary);
}
html.dark-theme .ai-quick-btn:hover {
    background: rgba(52,54,56,0.12);
    color: var(--text-primary);
}
@keyframes fadeUp {
...
.ai-msg-avatar.bot {
    background: linear-gradient(135deg, #343638, #1a1b1c);
    color: white;
    box-shadow: 0 2px 8px rgba(52,54,56,0.3);
}
...
.ai-message.ai-user {
    ...
    box-shadow: 0 2px 10px rgba(52,54,56,0.25);
}
...
.ai-input-wrapper:focus-within {
    border-color: rgba(52,54,56,0.5);
    box-shadow: 0 0 0 3px rgba(52,54,56,0.08);
    background: var(--card-bg);
}
...
html.dark-theme .ai-input-wrapper:focus-within {
    background: var(--form-bg);
    box-shadow: 0 0 0 3px rgba(52,54,56,0.12);
}
...
#ai-send-btn:not(:disabled):hover {
    ...
    box-shadow: 0 2px 10px rgba(52,54,56,0.35);
}
.ai-disclaimer {
    text-align: center;
    font-size: 0.62rem;
