...
class SupervisorController extends BaseController {
    ...
    public function committeeDashboard() {
        ...
        $this->render('supervisor/committee_dashboard', [
    ...
    public function committeeEvaluations() {
        $evaluatorId = $_SESSION['user_id'];
        $db = \Database::getInstance()->getConnection();
        ...
        $this->render('supervisor/committee_evaluations', [
            'groups' => $groups
        ]);
    }
    ...
    public function gradeEvaluation() {
        ...
        redirect('/supervisor/committee/evaluations');
    }
